...
In doing so, I utilise various SQL queries including "JOIN"s, "WITH"s, excluding certain data points with "!=" (NOT EQUAL TO), calculating new columns from existing columns, creating "VIEW"s and temp tables, and aliasing with "AS".
